...
//ADC
adc16_channel_config_t xADC16ChannelConfigStruct;
...
/******************************************************************************
 * Function		: void vMain_ADCInit( void )
 * Description	: Ham khoi tao ADC
 * Param		: none
 * Return		: none
*******************************************************************************/
void vMain_ADCInit( void )
{
	//Cau hinh dien ap tham chieu
...
//	VREF_SetTrimVal(VREF, 0x10);
    ...
    {
		APP_DEBUG("--- Main: ADC16_DoAutoCalibration() Done.\r\n");
    }
    else
    {
		APP_DEBUG("--- Main: ADC16_DoAutoCalibration() Failed.\r\n");
    }
#endif /* FSL_FEATURE_ADC16_HAS_CALIBRATION */

	//Cau hinh kenh
    xADC16ChannelConfigStruct.enableInterruptOnConversionCompleted = false;
#if defined(FSL_FEATURE_ADC16_HAS_DIFF_MODE) && FSL_FEATURE_ADC16_HAS_DIFF_MODE
    xADC16ChannelConfigStruct.enableDifferentialConversion = false;
